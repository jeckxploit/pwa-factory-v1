...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-black">
      ...
      >
        <form onSubmit={handleLogin} className="glass-card p-10 md:p-14 border-white/5 shadow-2xl">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-black tracking-tighter mb-3 italic">
              <span className="premium-gradient-text">LOGIN</span>
              <span className="text-white/20"> SYSTEM</span>
            </h1>
            <p className="text-zinc-600 text-[10px] font-bold uppercase tracking-widest">Akses panel produksi PWA Factory</p>
          </div>
          ...
          <p className="text-center text-zinc-500 text-[10px] font-bold uppercase tracking-widest">
            Belum punya akun? <Link to="/register" className="text-white hover:text-emerald-400 transition-colors ml-2 font-black italic underline underline-offset-4">Daftar Sekarang</Link>
          </p>
        </form>
      </motion.div>
    </div>
